...
| **C26 — l'Elo à `40/8`** | **36075386225, 36075388587** | `6daf7d7` → `4620495`, `40/8`, graine « auto » | 2 × 3 000, fastchess | lancés à 23 h 59, au plus tard vers 05 h 55 (plafond) | Mise en commun, puis le critère de correctif écrit avant (section C26) : **fusion sauf si la borne haute est sous zéro** ; une perte au temps du candidat se lit avant toute fusion |
