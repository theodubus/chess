...
| **balayage de mutation après la PR #72** | **35954091395** | `main` à `8ad3198`, les deux tests des survivants neufs | un job par fichier, puis `Verdict` | ~05 h 05 (lancé à 04 h 04) | `search.rs` **38 attendu** — les deux survivants neufs tués, rien d'autre ne bouge ; alors plafond à 38 |
