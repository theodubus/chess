...
| **A21 — le débit de génération sur runner** | **36166785450** | le générateur de `main` à `0eb1e9b`, 5 000 nœuds, graine « auto », un fil par processeur logique | un job court, 20 minutes | **lancé à 17 h 23**, fin vers 17 h 47 | *Attendu, écrit avant* (section A21) : **1 200 à 1 800 positions par seconde** ; l'artefact se dépose et se relit. Décide combien de jobs pour la première cible |
