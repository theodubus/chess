...
| 2026-09-21 | **C12 — PVS réécrit, à `8+0,08`** | **PAS LANCÉ.** Code sur `mesure/c12-pvs`, banc 114 028 → 106 820 (−6,3 %). Deux tests d'aspiration passent au rouge, et la sonde montre que **leur prémisse est fausse indépendamment de PVS** : sans LMP, le score de la boucle d'aspiration dépend déjà du pari **8,3 % du temps** (38/459, écart max 100 cp), contre 10,0 % avec PVS (46/459, max 232). Leur unique position tombe dans les 91,7 % stables. Arbitrage en attente — voir plus bas. |
