...
| **C25 — l'Elo** | **36035213241, 36035217166** | `41d590f` → `910a6c9`, `8+0,08`, graine « auto » | 2 × 3 000, fastchess | ~23 h 25, au plafond vers 2 880 parties chacun | Mise en commun, puis le critère en bornes écrit avant (section C25) : fusion seulement si la borne basse > 0 — pas sur un « pas d'effet décelable » ; une perte au temps se lit avant toute fusion |
