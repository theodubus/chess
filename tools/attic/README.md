...
| `c25-stabilite.patch` | **EN MESURE** : C25, par-dessus C24 — une échéance douce par classe de stabilité du coup (1,825 / 0,885 / 0,513 / 0,257 budget : il vient de changer, stable depuis 2 à 3 itérations, 4 à 6, 7 et plus), proportionnelle à la probabilité mesurée qu'une itération de plus le change ; la dure à 3 budgets, bornée par la pendule. Même contenu que le commit `41d590f`, révoqué aussitôt par `c4c356c` | **en vol** — sonde puis deux jobs à `8+0,08`, critère écrit avant (voir `tools/README.md`, section C25). À l'écran : +0,17 à +0,36 pli d'accord sur C24, moitiés tenues à l'écart | `git apply --check` : **oui**, sur `main` |
