...
| `c18-extension-echec.patch` | extension d'échec, bornée par le ply | **−5,01 Elo ± 8,11**, 3400 parties à longueur fixe, `8+0,08`, 21 sept. 2026 | `git apply --check` : **non** tant que C22 est dans l'arbre — il déplace le contexte de `negamax` où elle s'insère ; **oui** sur `main` |
