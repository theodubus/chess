...
| `c18-extension-echec.patch` | extension d'échec, bornée par le ply | **−5,01 Elo ± 8,11**, 3400 parties à longueur fixe, `8+0,08`, 21 sept. 2026 | `git apply --check` : **non** — elle touche la tête de `negamax`, où C22 a déplacé le test de nulle avant l'aiguillage vers la quiescence. La rejouer demande de la porter |
